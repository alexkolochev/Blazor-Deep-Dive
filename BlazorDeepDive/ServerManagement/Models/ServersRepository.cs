namespace ServerManagement.Models
{
    public static class ServersRepository
    {
        ...
        {
            return _servers.Where(s => s.City.Equals(cityName, StringComparison.OrdinalIgnoreCase)).ToList();
        }
        ...
        {
            return _servers.Where(s => s.Name.Contains(serverFilter, StringComparison.OrdinalIgnoreCase)).ToList();
        }
    }
}
